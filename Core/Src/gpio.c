...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_3|GPIO_PIN_6|SDMMC1_PWR_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PA3 PA6 SDMMC1_PWR_EN_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_3|GPIO_PIN_6|SDMMC1_PWR_EN_Pin;
